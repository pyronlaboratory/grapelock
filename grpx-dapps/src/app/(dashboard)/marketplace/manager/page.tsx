...
import { CollectionDetails, CollectionTable, GetStarted } from '@/components/nft/nft-ui'
...
export default function ManagerPage() {
  ...
  if (!collections || collections.length === 0) return <GetStarted />
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold">NFT Collections Manager</h1>
      {selectedCollection ? (
        <CollectionDetails
        ...
        <CollectionTable collections={mockCollections} onViewCollection={handleViewCollection} />
      )}
    </div>
  )
}
